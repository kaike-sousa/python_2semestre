#"python -i aula01.py" -> serve para executar um script Python e, ao final da execução, manter o interpretador interativo aberto (modo interativo) com todas as variáveis, funções e objetos definidos no script ainda disponíveis.
...
Como o nome do arquivo é muito comprido, pode digitar só 01 e apertar <tab>, o terminal
deve completar sozinho
...
Salve o arquivo apertando ctrl+s (ou clique 'file > autosave' para nao ter que
...
def quadrado(a):
    ...
    return resposta
'''
12. Feche o terminal, abra outro o faça o "python -i" de novo. Você tem que fazer
